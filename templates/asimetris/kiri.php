    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="big-cta">
                    <div class="cta-text">
                        <h2><span>ASIMETRIS : </span> <i>Exhibition Contractor, Interior and Exterior</i></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="box">
                            <div class="box-gray aligncenter">
                                ...
                                <p>
                                 Kami Menerima Jasa Desain Segala Macam Booth.
                                </p>
                    ...
                    <div class="col-lg-3">
                        <div class="box">
                            <div class="box-gray aligncenter">
                                <h4>Exhibition Contractor</h4>
                                <div class="icon">
                                <i class="fa fa-pagelines fa-3x"></i>
                                </div>
                                <p>
                                 Kami Menerima Jasa Exhibition Contractor.
                                </p>
                    ...
                    <div class="col-lg-3">
                        <div class="box">
                            <div class="box-gray aligncenter">
                                ...
                                <p>
                                 Kami Menerima Jasa Desain Interior Rumah, Gedung, dll.
                                </p>
                    ...
                    <div class="col-lg-3">
                        <div class="box">
                            <div class="box-gray aligncenter">
                                ...
                                <p>
                                 Kami Menerima Jasa Desain Eksterior Rumah, Gedung, dll.
                                </p>
		...
		?>
				...
				<article>
                  ...
                  <table>
                        ...
                        <tr><td> <?php echo $r['jam'] ?> </td></tr>
                        <tr><td><b>Place </b></td></tr>
                        <tr><td> <?php echo  $r['tempat'] ?> </td></tr>
                        </table><br />
    ...
    <div class='row'>
	  ...
	  <article>
                  ...
                  <table>
                        ...
                        <tr><td><?php echo $tgl_mulai ?> s/d <?php echo $tgl_selesai ?></td></tr>
                        <tr><td><b>Time </b></td></tr>
                        <tr><td> <?php echo $e['jam'] ?> </td></tr>
                        <tr><td><b>Place </b></td></tr>
                        <tr><td> <?php echo  $e['tempat'] ?> </td></tr>
                        </table><br />
        ...
        <h4>Informasi Kontak</h4>
         ...
         <?php
                    ...
                    <strong>CV. Asimetris</strong><br>
                         <h5>   Alamat : <?php echo "$t[alamat]"?></h5></address>
