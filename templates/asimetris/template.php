        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="home"><img src="<?php echo "$f[folder]/img/logo-asimetris.png"?>" width="180" height="60"></a>
                </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="widget">
					...
					<img src="<?php echo "$f[folder]/img/logo-asimetris.png"?>" width="180" height="60">
                    <?php
                    $main=mysql_query("SELECT * FROM identitas ");
