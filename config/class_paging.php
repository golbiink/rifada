...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=halnews-1.html class='nextprev'><< First</a> 
                    <a href=halnews-$prev.html class='nextprev'>< Prev</a>";
}
else{ 
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=halnews-$i.html>$i</a>";
  }
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " <span class='nextprev'>...</span> <a href=halnews-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=halnews-$next.html>Next ></a>
                     <a href=halnews-$jmlhalaman.html>Last >></a> ";
}
else{
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=halagenda-1.html class='nextprev'><< First</a> 
                    <a href=halagenda-$prev.html class='nextprev'>< Prev</a>";
}
else{ 
	$link_halaman .= "<span class='nextprev'><< First</span><span class='nextprev'>< Prev </span> ";
}
...
// class paging untuk halaman staff (menampilkan semua staff) 
class Paging8{
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halstaff'])){
	$posisi=0;
	$_GET['halstaff']=1;
}
else{
	$posisi = ($_GET['halstaff']-1) * $batas;
}
return $posisi;
}
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=halstaff-1.html class='nextprev'><< First</a>  
                    <a href=halstaff-$prev.html class='nextprev'>< Prev</a>";
}
else{ 
	$link_halaman .= "<span class='nextprev'><< First</span><span class='nextprev'>< Prev </span> ";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=halstaff-$i.html>$i</a>";
  }
	  $angka .= "<span class='current'><b>$halaman_aktif</b></span>";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " <span class='nextprev'>...</span> <a href=halstaff-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=halstaff-$next.html>Next ></a>
                     <a href=halstaff-$jmlhalaman.html>Last >></a> ";
}
else{
	$link_halaman .= "<span class='nextprev'>Next> </span><span class='nextprev'>Last >></span>";
}
...
// class paging untuk halaman portofolio (menampilkan semua portofolio) 
class Paging10{
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halportofolio'])){
	$posisi=0;
	$_GET['halportofolio']=1;
}
else{
	$posisi = ($_GET['halportofolio']-1) * $batas;
}
return $posisi;
}
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=halportofolio-1.html class='nextprev'><< First</a>  
                    <a href=halportofolio-$prev.html class='nextprev'>< Prev</a>  ";
}
else{ 
	$link_halaman .= "<span class='nextprev'><< First</span><span class='nextprev'>< Prev </span> ";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=halportofolio-$i.html>$i</a> ";
  }
	  $angka .= "  <span class='current'><b>$halaman_aktif</b></span> ";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " <span class='nextprev'>...</span>  <a href=halportofolio-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=halportofolio-$next.html>Next ></a>
                     <a href=halportofolio-$jmlhalaman.html>Last >></a> ";
}
else{
	$link_halaman .= "<span class='nextprev'>Next> </span><span class='nextprev'>Last >></span>";
}
